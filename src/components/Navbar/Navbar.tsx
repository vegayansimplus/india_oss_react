...
// import { DateTimeDisplayUTC } from "./DateTimeDisplay";
...
//     height: "3vh",
//     minHeight: "3vh",
//     // NOTE: fontSize for button container; actual label is inner span
//     fontSize: "3vh",
...
//         <Box>
//           <Grid container spacing="0.4vw" alignItems="center" sx={{ flexGrow: 0 }}>
//             {/* ----- FAULT (with dropdown) ----- */}
//             <Grid key={"fault"} display="flex" alignItems="center">
//               <Box>
//                 <Button
//                   variant="contained"
//                   color="primary"
//                   size="small"
//                   sx={btnSx}
//                   onClick={(e) => handleOpen(e, faultMenu.label)}
//                 >
...
//               >
//                 {faultMenu.options.map((option, optionIdx) => (
//                   <MenuItem
//                     key={optionIdx}
...
//             {/* ----- INVENTORY (direct button; no dropdown) ----- */}
//             <Grid key={"inventory"} display="flex" alignItems="center">
//               <Box>
//                 <Button
//                   variant="contained"
//                   color="primary"
//                   size="small"
//                   sx={btnSx}
//                   onClick={() => navigate(INVENTORY_PATH)}
//                 >
//                   <Box display="flex" alignItems="center" justifyContent="center" sx={{ gap: "0.1vw" }}>
//                     <Box component="span" sx={labelSx}>
//                       INVENTORY
...
const NAV_ITEMS: NavItem[] = [
  ...
  { type: "link", label: "INVENTORY", path: "/inventory" }, // now also from array
];
