...
// const HistoricFaultTableForSidebar: React.FC<CommonTableProps> = ({
//   columnOrder,
//   dataObjects,
//   pageSize = 10,
//   viewGraph,
...
//   // ye key jab change hota hai, MRT poora remount hota hai (selection reset)
//   const [tableResetKey, setTableResetKey] = useState(0);

//   /* ========= COLUMN VISIBILITY LOGIC ========= */

//   // 1) mount pe purana LS clear kar do (jo bhi agar padha hai)
//   useEffect(() => {
//     try {
...
//   // 2) defaults from array (ONLY yahi se initial render)
...
//   // 3) har change pe persist (agar future me use karna ho to LS me mil jayega)
//   useEffect(() => {
//     try {
//       const key = `${LOCALSTORAGE_PREFIX}${tableId}`;
...
//   // 4) agar columnOrder ya defaultVisibleColumns change ho (code update / deploy)
//   useEffect(() => {
...
//                   justifyContent: 'center',
//                   ...(isHighlighted && {
//                     backgroundColor: '#e3f2fd', // same highlight
//                     borderRadius: '2px',
//                   }),
//                 }}
//               >
...
//                     </Button>
//                     <Box sx={{ fontSize: '1.0vw', fontWeight: '700', marginLeft: 24 }}>
//                       INDIA Active Faults
//                     </Box>
//                   </Box>
//                 </Box>
...
//   );
// };
// export default HistoricFaultTableForSidebar;
...
const HistoricFaultTableForSidebar: React.FC<CommonTableProps> = ({
  ...
  const showEmptyMessage =
    !isLoading && hasFetchedOnce && (!dataObjects || dataObjects.length === 0);
